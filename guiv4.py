...
class LiveTranslationApp:
    ...
    def setup_ui(self):
        ...
        self.translation_display = tk.Text(self.root, wrap=tk.WORD, height=10, width=60)
    ...
    def update_translation_display(self, translation):
        ...
        self.translation_display.yview(tk.END)  # Scroll to the bottom to show latest translation
